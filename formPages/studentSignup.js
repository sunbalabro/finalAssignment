    ...
    <ImageBackground source={Back} style={styles.Bg} >
        ...
        />
            ...
            value={phoneNumber}
        />
            <Text style={{width:250,marginTop:10}}>Grade</Text>
        ...
        >
            ...
            <Picker.Item label="C" value="C" style={{width:20}} />
                
        </Picker>
        </View>
        <Text style={{width:250,marginTop:10}}>Group</Text>
        <View style={{width:250}}>
        <Picker
            selectedValue={selectedValue}
            style={{ height: 50, width: 100 }}
            onValueChange={(groupVal, itemIndex) => setgroupVal(groupVal)}
        >
            <Picker.Item label="Science" value="Science" style={{width:20}} />
            <Picker.Item label="Arts" value="Arts" style={{width:20}} />
            <Picker.Item label="Commerce" value="Commerce" style={{width:20}} />
